...
Gui, MainGUI:Add, CheckBox, checked%invcusthotwason% x22 y379 vinvcusthoton, Active Custom Combination Hotkey
...
Gui, MainGUI:Add, Text, x22 y409 w180 h20 , Stop the Combo Execution Hotkey
Gui, MainGUI:Add, Hotkey, x22 y429 w100 h30 ginvcusthot vinvcustcombcan, %mapinvcustcombcan%
Gui, MainGUI:Tab, 3
...
Gui, MainGUI:Add, Edit, vinvshow x4 y52 w155 h395 +ReadOnly,
Gui, MainGUI:Add, Text, x4 y450 w150 h16 , [ Custom Combination System ]
...
Gui, MainGUI:Add, Text,cGreen,Terminate this Tool Hotkey
...
Hotkey,%varwex%,wex
varexort=$%spell3%
Hotkey,%varexort%,exort
varsunstrike=$%spell5%
Hotkey,%varsunstrike%,sunstrike
varemp=$%spell6%
Hotkey,%varemp%,emp
varcoldsnap=$%spell7%
Hotkey,%varcoldsnap%,coldsnap
varchaosmeteor=$%spell8%
Hotkey,%varchaosmeteor%,chaosmeteor
varforgespirit=$%spell9%
Hotkey,%varforgespirit%,forgespirit
varalacrity=$%spell10%
Hotkey,%varalacrity%,alacrity
vartornado=$%spell11%
Hotkey,%vartornado%,tornado
varicewall=$%spell12%
Hotkey,%varicewall%,icewall
varghostwalk=$%spell13%
Hotkey,%varghostwalk%,ghostwalk
vardeafeningblast=$%spell14%
Hotkey,%vardeafeningblast%,deafeningblast
}
if (EnMeepoHK = "1")
{
varallpoof=$%spell15%
Hotkey,%varallpoof%,allpoof
varclonepoof=$%spell16%
Hotkey,%varclonepoof%,clonepoof
varallboots=$%spell17%
Hotkey,%varallboots%,allboots
}
if (invcusthoton = "1")
{
	if invcustcombcan<>
	{
		...
		{
			varinvcustcombcan=$%invcustcombcan%
			Hotkey, %varinvcustcombcan%,invcustcombcanhk
		}
	}
	if RegisteredDirectory<>ERROR
	{
		if RegisteredDirectory>0
		{
			Loop, %RegisteredDirectory%
			{
				...
				{
					tempvarhk:=CCDirectory%A_Index%Hotkey
					tempvarhk=$%tempvarhk%
					Hotkey,%tempvarhk%,reginvfilehk
				}
			}
		}
	}
}
varsuspendhk=$%hotkeysuspend%
varterminatehk=$%hotkeyterminate%
Hotkey,%varsuspendhk%,suspendhk
Hotkey,%varterminatehk%,terminatehk
...
guiparam=invhkon,orb3x,mpohkon,qcon,fcon,invcusthotwason,mapinvcustcombcan,waspgrmode,pgren,suspendhotkey,terminatehotkey,runasadmin
Loop, parse, guiparam, `,
{
...
hkparam=Q|W|E|R|^T|^C|^Y|^D|^F|^Z|^X|^G|^V|^B|R|Q|``|F|!Q|E|Home|End|0|+ReadOnly|1
param=invo1|invo2|invo3|invo4|invo5|invo6|invo7|invo8|invo9|invo10|invo11|invo12|invo13|invo14|invo15|invo16|invo17|invo18|invo19|invo20|suspendhotkey|terminatehotkey|waspgrmode|pgren|runasadmin
Loop, parse,hkparam,|
{
	tempvar=%A_LoopField%
	tempint=%A_Index%
...
hkparam=%EnInvokerHK%|%tripplepress%|%EnMeepoHK%|%quickcaston%|%fastcaston%|%invcusthoton%|%invcustcombcan%|%hotkeysuspend%|%hotkeyterminate%|%runadmin%
param=invhkon|orb3x|mpohkon|qcon|fcon|invcusthotwason|mapinvcustcombcan|suspendhotkey|terminatehotkey|runasadmin
Loop, parse,hkparam,|
{
	tempvar=%A_LoopField%
	tempint=%A_Index%
...
else
{
	...
	guiparam=EnInvokerHK,tripplepress,invcustcombcan,EnMeepoHK,quickcaston,invcusthoton,hotkeysuspend,hotkeyterminate,runadmin,invshow,invdirbox,invlv,invfilehk,pgrmode
	Loop, parse, guiparam, `,
	{
...
param=hotkeysuspend|hotkeyterminate
Loop,Parse,param,|
{
	varloop:=%A_LoopField%
	If newhook=%varloop%        ;  Check for duplicate hotkey...
...
Gui, mpoguicustcomb:Add, DropDownList, x262 y199 w210 h90 Choose1 vselectinstance, Cast EarthBind|Cast Poof|Select Prime Meepo|Select 1st Clone Meepo|Select 2nd Clone Meepo|Select 3rd Clone Meepo|Select 4th Clone Meepo
...
pgrstring=sendinput`, {F1}`%spell20`%|sendinput`, 7`%spell18`%|sendinput`, 7`%spell20`%|sendinput`, {F1}`%spell18`%|sendinput`, 8`%spell20`%|sendinput`, 8`%spell18`%|sendinput`, 0`%spell20`%|sendinput`, 9`%spell20`%|sendinput`, 9`%spell18`%|sendinput`, 0`%spell18`%|sendinput`, {Click up right}|sendinput`, `%spell20`%|sendinput`, `%spell18`%|sendinput`, {F1}|sendinput`, 7|sendinput`, 8|sendinput`, 9|sendinput`, 0|sleep
langstring=Make Prime Meepo Cast EarthBind|Make 1st Clone Meepo Cast Poof|Make 1st Clone Meepo Cast EarthBind|Make Prime Meepo Cast Poof|Make 2nd Clone Meepo Cast EarthBind|Make 2nd Clone Meepo Cast Poof|Make 4th Clone Meepo Cast EarthBind|Make 3rd Clone Meepo Cast EarthBind|Make 3rd Clone Meepo Cast Poof|Make 4th Clone Meepo Cast Poof|Right-Click Mouse|Cast EarthBind|Cast Poof|Select Prime Meepo|Select 1st Clone Meepo|Select 2nd Clone Meepo|Select 3rd Clone Meepo|Select 4th Clone Meepo|After Milliseconds >
...
mpoinstance:
Gui, mpoguicustcomb:Submit, NoHide
pgrstring=sendinput`, `%spell20`%|sendinput`, `%spell18`%|sendinput`, {F1}|sendinput`, 7|sendinput`, 8|sendinput`, 9|sendinput`, 0
langstring=Cast EarthBind|Cast Poof|Select Prime Meepo|Select 1st Clone Meepo|Select 2nd Clone Meepo|Select 3rd Clone Meepo|Select 4th Clone Meepo
Loop, parse, langstring,|
{
...
if (invfc = "1")
{
	GuiControl,Text,invocustbox,%invocustbox%sendinput`, `%spell2`%`%spell2`%`%spell3`%`%spell4`%`nsleep 200`nsendinput`, zz`n
}
else
{
...
if (A_IsSuspended="1")
{
sendinput, {Enter}A.J.O.M.'s Tool is Suspended{Enter}
}
else
{
sendinput, {Enter}A.J.O.M.'s Tool is Resumed{Enter}
}
return
...
pgrtranslate:
spell1`%`%spell2`%`%spell4`%|`%spell2`%`%spell1`%`%spell2`%`%spell4`%|`%spell1`%`%spell3`%`%spell3`%`%spell4`%|`%spell2`%`%spell1`%`%spell3`%`%spell4`%|{Click}|sendinput`, {F1}`%spell20`%|sendinput`, 7`%spell18`%|sendinput`, 7`%spell20`%|sendinput`, {F1}`%spell18`%|sendinput`, 8`%spell20`%|sendinput`, 8`%spell18`%|sendinput`, 0`%spell20`%|sendinput`, 9`%spell20`%|sendinput`, 9`%spell18`%|sendinput`, 0`%spell18`%|sendinput`, `%spell20`%|sendinput`, `%spell18`%|sendinput`, {F1}|sendinput`, 7|sendinput`, 8|sendinput`, 9|sendinput`, 0
langstring=Invoke-Cast Coldsnap|InvokeCast Coldsnap|Invoke Coldsnap|Invoke-Cast SunStrike|InvokeCast SunStrike|Invoke SunStrike|Invoke-Cast EMP|InvokeCast EMP|Invoke EMP|InvokeCast IceWall|Invoke IceWall|InvokeSelfCast Alacrity|Invoke Alacrity|Invoke-Cast Chaos Meteor|InvokeCast Chaos Meteor|Invoke Chaos Meteor|InvokeCast GhostWalk|Invoke GhostWalk|Invoke-Cast Tornado|InvokeCast Tornado|Invoke Tornado|InvokeCast Forge Spirit|Invoke Forge Spirit|Invoke-Cast Deafening Blast|InvokeCast Deafening Blast|Invoke Deafening Blast|Move-to Mouse-Selection|After Milliseconds >|Cast-Sunstrike|Cast Sunstrike|Cast-EMP|Cast EMP|Cast-ColdSnap|Cast ColdSnap|Cast-Chaos Meteor|Cast Chaos Meteor|Cast Forge Spirit|Cast Alacrity|Cast-Tornado|Cast Tornado|Cast GhostWalk|Cast IceWall|Cast-Deafening Blast|Cast Deafening Blast|ColdSnap|SunStrike|EMP|IceWall|Alacrity|Chaos Meteor|GhostWalk|Tornado|Forge Spirit|Deafening Blast|(Left-Click Mouse)|Make Prime Meepo Cast EarthBind|Make 1st Clone Meepo Cast Poof|Make 1st Clone Meepo Cast EarthBind|Make Prime Meepo Cast Poof|Make 2nd Clone Meepo Cast EarthBind|Make 2nd Clone Meepo Cast Poof|Make 4th Clone Meepo Cast EarthBind|Make 3rd Clone Meepo Cast EarthBind|Make 3rd Clone Meepo Cast Poof|Make 4th Clone Meepo Cast Poof|Cast EarthBind|Cast Poof|Select Prime Meepo|Select 1st Clone Meepo|Select 2nd Clone Meepo|Select 3rd Clone Meepo|Select 4th Clone Meepo
Loop,Parse,pgrstring,|
{
	if pgrmode=1
	{
...
else if InStr(ErrorLevel, "C", true)
{
	...
	param=hotkeysuspend,hotkeyterminate
	nameparam=Suspend this Tool Hotkey|Terminate this Tool Hotkey
	Loop,parse,param,`,
	{
		tempvar:=%A_LoopField%
...
{
	GuiControl,Text,invocustbox,%invocustbox%sendinput`, zz`n
}
...
Loop %AHKWindows%
{
	...
	if ccregvar%A_Index%<>
	{
		...
		{
			if ccregvar%A_Index%:=AHKWindows%A_Index%_PID
			{
				WinKill, % "ahk_pid " AHKWindows%A_Index%_PID
			}
		}
	}
}
